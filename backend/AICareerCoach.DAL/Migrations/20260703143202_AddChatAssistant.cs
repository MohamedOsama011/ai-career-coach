...
{
    /// <inheritdoc />
    public partial class AddChatAssistant : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToolCallsJson = table.Column<string>(type: "nvarchar(max)", maxLength: -1, nullable: true),
                    ToolCallId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ToolName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
