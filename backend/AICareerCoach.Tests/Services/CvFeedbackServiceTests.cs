...
namespace AICareerCoach.Tests.Services
{
    public class CvFeedbackServiceTests
    {
        ...
        public async Task GetFeedbackAsync_UsesCache_WhenAvailable()
        {
            ...
            var cached = new AiFeedbackCache { Id = 1, UserId = "u1", CvHash = "h", FeedbackJson = JsonSerializer.Serialize(new AICareerCoach.BLL.DTOs.CV.CvFeedbackDto { OverallScore = 10 }) };
